    ...
    function ha(b) {
        ...
        function u(a) {
            var e,
                b = a ? a.indexOf('!') : -1
            ;-1 < b &&
                ((e = a.substring(0, b)), (a = a.substring(b + 1, a.length)))
            return [e, a]
        }
        function m(a, e, b, f) {
            var n,
                ...
                a.packages &&
                    v(a.packages, function (a) {
                        ...
                        l.pkgs[b] =
                            a.name +
                            '/' +
                            (a.main || 'main').replace(ja, '').replace(R, '')
                    })
                B(k, function (a, b) {
